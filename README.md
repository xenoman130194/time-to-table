...
# Time-To-Table v0.6.3 (Калькулятор для ленивых)

> автор: Галимзянов Г.Р.

Эта программа распространяется бесплатно. Автор добровольно отказывается от получения оплаты за использование.
